...
public class TestExample1 
{
	...
	//http://localhost:8080/products-ut-wo-db/endpoints/rest/availableProducts
	@Test
	...
	//http://localhost:8080/products-ut-wo-db/endpoints/rest/product/creates
	...
	//http://localhost:8080/products-ut-wo-db/endpoints/rest/product/1
    ...
    //http://localhost:8080/products-ut-wo-db/endpoints/rest/product/productDescriptionEnglish/CHICKEN%20NOODLE%20SOUP       	
	@Test
	...
	List<LinkedHashMap> products = restTemplate.getForObject(SERVER_URI+"/rest/product/productDescriptionEnglish/CHICKEN%20NOODLE%20SOUP", List.class);
	   System.out.println("number of records:"+products.size());
		for(@SuppressWarnings("rawtypes") LinkedHashMap map : products){
	...
	public  void testGetProductIdAndProductDescriptionEnglish() {
			//http://localhost:8080/products-ut-wo-db/endpoints/rest/product/1/productIdAndProductDescriptionEnglish/CHICKEN%20NOODLE%20SOUP
	...
	//http://localhost:8080/products-ut-wo-db/endpoints/rest/products
